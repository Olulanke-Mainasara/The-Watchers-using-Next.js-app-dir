...
function CategoriesCarousel() {
  ...
  return (
    <section style={{ scrollSnapAlign: "start" }} className="w-full h-screen overflow-hidden flex flex-col gap-10 items-center justify-center text-center allEMT:my-36">
