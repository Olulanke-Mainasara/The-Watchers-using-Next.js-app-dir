        ...
        <div className="h-full mx-auto flex items-center justify-between px-10 sm:px-5 xs:px-3 iphone5:px-3 xtraSmall:px-2">
            <div className="flex space-x-20">
                ...
                <ul className={"flex items-center text-white space-x-20 allIL:absolute allIL:top-0 allIL:h-screen allIL:w-full allIL:flex-col allIL:justify-center allIL:gap-12 allIL:space-x-0 allIL:bg-black duration-500 " + navMenu}>
                    <li><Link href="#" className="relative after:absolute after:left-0 after:-bottom-2 after:h-[2px] after:w-full after:scale-x-0 after:bg-white after:duration-500 after:content-[''] hover:transition-transform hover:after:scale-x-110">Home</Link></li>
                    <li className="group relative" id="dropDown">
                        ...
                        <div id="dropList" className="absolute z-30 h-0 group-hover:h-[362px] -left-[45%] pt-[22px] duration-500 overflow-hidden">
                            <ul className="border rounded-xl text-center w-60 bg-black dark:bg-gray-600 overflow-hidden">
                                <li className="w-full py-4 px-3 hover:bg-gray-800 duration-500"><Link href="#" className="py-4 px-[26px]">Space Exploration</Link></li>
                                <li className="w-full py-4 px-3 hover:bg-gray-800 duration-500"><Link href="#" className="py-4 px-[26px]">World of Science</Link></li>
                                <li className="w-full py-4 px-2 hover:bg-gray-800 duration-500"><Link href="#" className="py-4 px-[26px]">Feat in Transportation</Link></li>
                                <li className="w-full py-4 px-3 hover:bg-gray-800 duration-500"><Link href="#" className="py-4 px-[26px]">History</Link></li>
                                <li className="w-full py-4 px-3 hover:bg-gray-800 duration-500"><Link href="#" className="py-4 px-[26px]">Art and Entertainment</Link></li>
                                <li className="w-full py-4 px-3 hover:bg-gray-800 duration-500"><Link href="#" className="py-4 px-[26px]">Upload your article</Link></li>
                            </ul>
                        </div>
                    </li>
            ...
            <div className="flex space-x-10 items-center allIL:hidden">
                <div>
                ...
                <button title="Login" className="w-10 h-10 border rounded-full flex items-center justify-center text-xl text-white hover:text-gray-800 hover:bg-white duration-500 lg:hover:bg-transparent"><FontAwesomeIcon icon={ faUser } /></button>
