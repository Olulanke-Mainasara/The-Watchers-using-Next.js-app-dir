...
function NewsCarousel() {
  ...
  return (
    <section className="w-full h-screen row overflow-hidden flex flex-col gap-10 items-center justify-center text-center my-28">
      ...
      <div className="relative w-screen h-[500px] 2xl:h-[650px] lg:h-[350px] md:h-[800px] allT:h-[420px] flex items-center overflow-x-hidden">
        ...
        <Link title="Next page" className="w-12 h-12 allIL:h-14 flex items-center justify-center z-10 absolute rounded-full text-xl transition-colors top-1/2 -translate-y-1/2 right-2 allIL:right-0 duration-300 allEM:w-6 allT:w-4 allIL:rounded-tr-none allIL:rounded-br-none dark:text-white dark:bg-black dark:hover:bg-white dark:hover:text-black allIL:dark:hover:text-white allIL:dark:hover:bg-black allEMT:shadow-none" onClick={ nextNews } href="#"><FontAwesomeIcon icon={ faChevronRight } /></Link>
