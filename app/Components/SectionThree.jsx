    ...
    <section className="w-full h-screen flex allEMT:flex-col allIL:h-auto allIL:py-[210px]">
        <section className="w-1/2 h-full flex items-center justify-center allEMT:w-screen allEMT:h-2/5">
            <div className="w-4/5 h-3/5 flex flex-col justify-center gap-7 dark:text-white allLM:h-[705px] allEMT:text-center allEMT:my-14">
                ...
                <Link href="#categories" title="Categories" className="rounded-3xl bg-gray-800 px-9 py-4 text-white w-fit mx-auto text-xl transition-colors duration-300 hover:bg-gray-800 hover:text-white allT:text-base allEM:text-base allIL:hover:bg-white allIL:hover:text-gray-800">Start reading</Link>
            </div>
        </section>
