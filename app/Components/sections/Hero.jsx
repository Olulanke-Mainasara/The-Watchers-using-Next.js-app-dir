...
function Hero() {
  return (
     <header style={{ scrollSnapAlign: "start" }} className="flex h-screen items-center bg-[url(/Header.jpeg)] bg-cover bg-scroll allIL:bg-[url(/headerM.jpg)] allIL:bg-bottom">
