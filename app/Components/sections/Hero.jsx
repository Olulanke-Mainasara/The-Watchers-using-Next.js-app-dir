...
function Hero() {
  return (
    <header
      ...
      className="flex h-screen items-center bg-[url(/Header.jpeg)] bg-cover allIL:bg-[url(/headerM.jpg)] allIL:bg-bottom"
    >
      <div className="w-full h-full justify-center flex flex-col gap-8 backdrop-brightness-50 text-center">
        ...
        <div className="mt-4">
          <Link
            href="#"
            title="Categories"
            className="rounded-3xl border border-black bg-white px-5 py-4 text-black text-2xl transition-colors duration-300 hover:bg-black hover:text-white hover:border-white allEMT:text-lg"
          >
            Start reading
          </Link>
          <a
            href='#news'
            className="px-7 py-4 text-white text-2xl allEMT:text-lg allEM:pr-0 allT:hidden"
